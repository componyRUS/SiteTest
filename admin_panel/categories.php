           ...
           <?php include 'include/admin_sidebar.php';?>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                if (isset($_GET['delete']) && $_GET['delete'] == 'success') {
                    echo "<div class='alert alert-success' role='alert'>Категория успешно удалена!</div>";
                }
                if (isset($_GET['add']) && $_GET['add'] == 'success') {
                    echo "<div class='alert alert-success' role='alert'>Категория успешно добавлена!</div>";
                 }
                if (isset($_GET['edit']) && $_GET['edit'] == 'success') {
                     echo "<div class='alert alert-success' role='alert'>Категория успешно обновлена!</div>";
                }
                ?>
