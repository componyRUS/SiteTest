...
?>
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-6">
                <img src="uploads/img/<?php echo htmlspecialchars($product['img1']); ?>" class="img-fluid" alt="<?php echo htmlspecialchars($product['ProductName']); ?>" style="width: 100%; height: auto; max-width: 500px; max-height: 500px;">
                </div>
                <div class="col-md-6">
                    ...
                    <p><strong>Ширина:</strong> <?php echo htmlspecialchars($product['Width']); ?> </p>
                    <p><strong>Длина:</strong> <?php echo htmlspecialchars($product['Length']); ?> </p>
                    <p><strong>Высота:</strong> <?php echo htmlspecialchars($product['Height']); ?> </p>
